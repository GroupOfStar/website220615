import { INewsItem } from "../Home/interface";
import { WorkExperienceItem } from "./interface";

// 待办事项列表
export const todoList: INewsItem[] = [
  { id: 1, title: '昆明分行2021年各职能部门内部满意度评价 上半年-按指标评估', time: '2021年8月6日' },
  { id: 2, title: '昆明分行2020年考核部门员工 年度-按指标评估', time: '2021年1月13日' },
]

// 成长历程
export const growthProcess: INewsItem[] = [
  { id: 1, title: '中信银行大理分行 零售银行部 副总经理 二级分行部门副总经理', time: '2021-04-13' },
